...
-- admin_clients_mailboxes definition

-- Drop table

-- DROP TABLE admin_clients_mailboxes;

CREATE TABLE admin_clients_mailboxes (
	id int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	...
	created_by uuid NULL,
	updated_by uuid NULL,
	CONSTRAINT admin_clients_mailboxes_pk PRIMARY KEY ("user")
);
CREATE INDEX admin_clients_mailboxes_client_uid_idx ON admin_clients_mailboxes USING btree (client_uid);
