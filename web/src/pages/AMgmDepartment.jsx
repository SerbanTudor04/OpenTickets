...
import { createDepartment, deleteDepartment, getDepartments, updateDepartment } from "../../../package/api/ausers";
                        ...
                        >
                          ...
                          <Table.Cell>
                            ...
                            />
                              ...
                              <DeleteDept    id={"deletemodalView--" + item.id}
                              dept={item}/>
                              </div>
                            </div>
                          </Table.Cell>
            ...
            <div className="space-y-6 px-6 pb-4 sm:pb-6 lg:px-8 xl:pb-8">
              ...
              <div>
                ...
                <Textarea
                  ...
                  required={true}
                  value={
                    curentData?.description ?? props?.dept?.description
                  }
                  onChange={(e) => {
                    let cData = { ...curentData };
              ...
              <div className="w-full">
                {props.dept ? (
                  <Button onClick={update}>{(isSaving)?<Spinner/>: "Save changes"}</Button>
                ) : (
                  <Button onClick={create}> {(isSaving)?<Spinner/>: "Create department"}</Button>
                )}
              </div>
            </div>
          </Modal.Body>
      ...
      <Modal.Body>
        <div className="text-center">
          ...
          <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
            Are you sure you want to delete <strong>{props?.dept?.name}</strong>?
          </h3>
