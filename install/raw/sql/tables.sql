...
-- tickets.admin_clients_mailboxes definition
...
CREATE INDEX admin_clients_mailboxes_client_uid_idx ON tickets.admin_clients_mailboxes USING btree (client_uid);
...
CREATE INDEX admin_clients_notes_client_uid_idx ON tickets.admin_clients_notes USING btree (client_uid);
...
CREATE UNIQUE INDEX emails_templates_name_idx ON tickets.emails_templates USING btree (name);
...
-- tickets.reports_scores_nomenclator definition
...
CREATE INDEX reports_scores_nomenclator_name_idx ON tickets.reports_scores_nomenclator USING btree (name);


-- tickets.reports_users_balances definition
...
CREATE UNIQUE INDEX reports_users_scores_user_id_idx ON tickets.reports_users_balances USING btree (user_id);


-- tickets.reports_users_balances_daily definition
...
-- tickets.reports_users_balances_monthly definition
...
-- tickets.reports_users_balances_yearly definition
